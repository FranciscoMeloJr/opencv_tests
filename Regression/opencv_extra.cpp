...
int main(int argc, char** argv) {
   ...
   // results.
	//
	Mat imgA = imread("../data/OpticalFlow0.jpg",CV_LOAD_IMAGE_GRAYSCALE);
	Mat imgB = imread("../data/OpticalFlow1.jpg",CV_LOAD_IMAGE_GRAYSCALE);
	Size img_sz = imgA.size();
	int win_size = 10;
	Mat imgC = imread("../data/OpticalFlow1.jpg",CV_LOAD_IMAGE_UNCHANGED);
